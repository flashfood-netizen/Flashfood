  ...
  return (
    <div className="screen">
      ...
      <div className="center">
        <span className="tag">طلب.دفع.تحضير</span>
...
function Trial({ go, back }) {
  ...
  const submit = () => {
    ...
    setErr(e);
    if (!Object.values(e).some(Boolean)) go("trialDone", { form: f });
  };
  ...
  return (
    <div className="screen">
      ...
      <div className="gap">
        <button className="btn btn-night" onClick={submit}>ابدأ التجربة</button>
      </div>
      <p className="foot">
        لديك حساب؟ <button className="link" onClick={() => go("login")}>سجّل الدخول</button>
      </p>
...
function Pay({ go, back, data }) {
  ...
  return (
    <div className="screen">
      ...
      <div className="gap">
        <button className="btn btn-flame" onClick={submit}>إنشاء الحساب وإرسال الطلب</button>
      </div>
    </div>
  );
}
...
function Login({ go, back }) {
  ...
  const submit = () => {
    ...
    setErr({ form: "البريد الإلكتروني أو كلمة السر غير صحيحة" });
  };
  ...
  return (
    <div className="screen">
      ...
      <div className="gap">
        <button className="btn btn-night" onClick={submit}>دخول</button>
      </div>
      <p className="foot">
